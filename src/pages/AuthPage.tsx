    ...
    <div className="min-h-screen bg-app flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-violet-500 to-indigo-600 shadow-lg shadow-indigo-500/30 flex items-center justify-center mb-4">
        ...
        <div className="rounded-2xl border border-token bg-surface p-7 shadow-2xl shadow-black/40">
          ...
          {/* Google button — circular icon style */}
          <div className="flex justify-center mb-5">
            <button
              onClick={handleGoogleLogin}
              disabled={googleLoading || loading}
              title="Continue with Google"
              className="h-12 w-12 flex items-center justify-center rounded-full border border-token bg-app hover:bg-white/[0.07] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
              {googleLoading ? (
          ...
          <form onSubmit={handleEmailAuth} className="flex flex-col gap-4">
            ...
            {!isLogin && (
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-token bg-app px-4 py-2.5 text-sm text-primary placeholder-slate-600 outline-none focus:border-accent/60 transition-colors"
                />
              </div>
            )}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-token bg-app px-4 py-2.5 pr-10 text-sm text-primary placeholder-slate-600 outline-none focus:border-accent/60 transition-colors"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full rounded-xl bg-accent hover:bg-accent py-2.5 text-sm font-semibold text-primary transition-colors disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-1"
            >
